...
- **A practical function reference** (`FUNCTIONS.md`)
...
3. [Function Reference](FUNCTIONS.md)
...
12. [Comparison to XSLT](#comparison-to-xslt)
13. [Language Design Notes](#language-design-notes)
...
js      median 0.2026s (runs: 0.2168, 0.1993, 0.2026)
```
